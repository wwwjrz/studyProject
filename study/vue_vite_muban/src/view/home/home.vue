  ...
  <div class="common-layout">
    <el-container>
      <el-aside width="collapse">
        <el-menu :router="true" class="el-menu-vertical" :collapse="isCollapse" :default-active="menuDefault"
          mode="vertical">
...
let navList = reactive([
  ...
  { id: 1, name: "element", path: "/element", icon: "ElementPlus", children: [{ id: '1-1', name: '骨架屏', path: '/element/skeleton', icon: "Operation", children: [] }] },
